...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="/" title=""><?=TITLE_HEADER_SMALL?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="https://github.com/otolaa/bitrix_recaptchav3" target="_blank" rel="nofollow">
    ...
    if (Loader::includeModule('recaptcha.v3')) :
        ...
        if ($get['method'] == "POST" && is_set($get['recaptcha_'.$sid]) && strlen($get['recaptcha_'.$sid]))
        {
            ...
            if ($get["recaptcha"]['success'] == 'N') {
                $error['RECAPTCHA'] = Option::get("recaptcha.v3", "RECAPTCHA_ERROR", "Y");
            } elseif ($get["recaptcha"]['success'] == 'S') {
                $error['RECAPTCHA'] = Option::get("recaptcha.v3", "RECAPTCHA_ERROR_SCORE", "Y");
            }
        } ?>
