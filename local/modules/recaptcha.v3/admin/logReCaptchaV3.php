...
require_once(Loader::getLocal("modules/recaptcha.v3/include.php")); // инициализация модуля
require_once(Loader::getLocal("modules/recaptcha.v3/prolog.php")); // пролог модуля

// подключим языковой файл
Loc::loadMessages(__FILE__);
//
if(!Loader::includeModule("recaptcha.v3")) return;

// получим права доступа текущего пользователя на модуль
$POST_RIGHT = $APPLICATION->GetGroupRight("recaptcha.v3");
...
$APPLICATION->SetTitle("Лог ответов ReCaptcha.V3"); // установка заголовка
